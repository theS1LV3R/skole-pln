<template>
  <header class="bg-nord-nord6 dark:bg-dark-container w-full">
    <div
      class="max-w-screen-lg py-4 px-12 m-auto flex justify-between items-center"
    >
      <NuxtLink to="/"
        ><h1 class="text-3xl -pr-4">{{ title }}</h1></NuxtLink
      >
